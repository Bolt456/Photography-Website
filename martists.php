                ...
                <form method="POST"  enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <select name="id" id="update_artist" class="form-control" required onchange="fetchArtistDetails(this.value)">
                            ...
                            <?php
                                // Fetch all artists from the database for  dropdown
...
function confirmDelete() {
    var artistName = document.getElementById("artistDropdown").options[document.getElementById("artistDropdown").selectedIndex].text;
    if (artistName === "Select Artist") {
        alert("Please select an artist to delete.");
        return false;
    }
    return confirm("Are you sure you want to delete the artist: " + artistName + "? This action cannot be undone.");
}
</script>
