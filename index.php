        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-3 active" aria-current="page" href="review.php">Review</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-3 active" aria-current="page" href="login.php">Login</a>
                    </li>
                </ul>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item" href="booking.php">View Bookings</a></li>
                        <li><a class="dropdown-item" href="availability.php">Check Availability</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="login.php" onclick="logoutUser()">Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
